const state={items:[],selectedPath:null,doc:null,original:"",dirty:false};
const $=id=>document.getElementById(id);
const els={};
["monsterList","filterInput","newButton","reloadButton","saveButton","documentTitle","documentPath","dirtyBadge","emptyState","editor","idInput","schemaInput","debugNameInput","healthInput","halfXInput","halfYInput","speedInput","leashInput","kindInput","aggroInput","jsonEditor","applyRawButton","validationStatus","validationErrors","summaryId","statusText"].forEach(id=>els[id]=$(id));
